1)Synthetic Data Generation: Created a structured dataset simulating system metrics (e.g., CPU temperature, memory usage) with random values, saved as synthetic_dataset.csv.
